...
import {MdDelete, MdOutlineDataSaverOn, MdOutlineFileDownload} from "react-icons/md";
                ...
                <div className="bg-white w-[60%] p-3 rounded-md">
                    ...
                    <div className="flex justify-end items-center gap-5">
                        <div className="cursor-pointer"
                             onClick={() => window.location.href = CONFIG.API_BASE_URL + '/documents/' + data?.path}>
